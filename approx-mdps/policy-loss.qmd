...
$$
  π_{\hat V}(s) \in \arg \min_{a \in \ALPHABET A} 
...
$\| V^* - V_{π_{\hat V}}\|_{∞}$. We call this **the policy loss**.
...
\begin{align*}
  ...
  +
  \| \BELLMAN_{π_{\hat V}} V^* - \BELLMAN_{π_{\hat V}} V_{π_{\hat V}} \|_{∞}
  \\
  &\le
  γ \| V^* - \hat V \|_{∞}
  + 
...
$$
\| \BELLMAN \hat V - \BELLMAN_{\hat π} V\| \le ε
$$
