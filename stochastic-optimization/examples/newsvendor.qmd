...
Recall that the CDF of the exponential distribution is given by
$$
  F(w) = 1 - e^{-\theta w}.
$$
...
$$
Then, the certainty equivalent action is given by $w_{\lceil \rho K \rceil: K}$.
...
$$
   a = \frac{1}{\hat \theta_K} \ln \frac{q}{p}.
$$
