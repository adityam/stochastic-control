...
![Tree representation of the one-step optimization problem. Nodes represent the "agent": nature or decision maker; the edges represent the moves of the agents; and the numbers at the leaf nodes represent the cost $c(s,a,w)$. The shaded edges represent a policy.](figures/game-tree-1.svg){#fig-tree1}
...
![Tree representation of the one-step optimization problem. Nodes represent the "agent": nature or decision maker; the edges represent the moves of the agents; and the numbers at the leaf nodes represent the cost $c(s,a,w)$. The shaded edges represent a policy.](figures/game-tree-2.svg){#fig-tree2}
