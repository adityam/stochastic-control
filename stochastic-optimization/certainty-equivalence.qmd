...
The material for the bounds in the general case is based on @Witsenhausen1969. For a significant generalization of these results, see @Witsenhausen1970. For a bound on certainty equivalent decision rules in multi-stage problems, see @Bozkurt2025.
