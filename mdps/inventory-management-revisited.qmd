...
Substituting in the definition of $F(s) = \EXP[V^*(s-W)]$, we get
$$
  F(s) = \EXP[c^*(s-W)] + γ \EXP[ F(\max\{s-W, σ\}) ].
$$
Rearranging the terms, we get
$$
  \EXP[c^*(s-W)] = F(s) - γ \EXP[ F(\max\{s-W, σ\}) ].
$$
...
problem][newsvendor]. In particular, let $f$ denote the
