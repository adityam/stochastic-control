...
$$
  \ALPHABET V_M \coloneqq \{ v \colon \ALPHABET S \to \reals \text{ such that } \| v \|_{∞} \le M \}
$$
where $M$ is any constant greater than $\|c\|_{∞}/(1-γ)$. Banach fixed point theorem says that DP has a **unique** fixed point in $\ALPHABET V_M$. It does not say anything about solutions outside $\ALPHABET V_M$!
