...
Consider the machine repair example from @exr-machine-replacement. We compute the optimal policy for this model when $W \sim \text{Binom}(n,p)$ when $n = 10$, $T = 20$, $h(s) = 2s$, and $λ=20$ for different values of $p$.
