...
module CallOptions_LFA
  ...
  function solve(; p=5.0, μ=0.0, σ=1.0, T=20, n=8, K=50, K_eval=500, n_quad=32)
    ...
    # Gauss-Hermite quadrature for E[V(s + W)] where W ~ N(μ, σ²)
...
//| fig-subcap:
//|     - Value function
//|     - Exercise policy (1=exercise, 0=continue)
//| layout-ncol: 2
