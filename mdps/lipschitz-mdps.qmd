...
$$
To understand the tightness of this bound, we consider a specific instance of inventory management problem where the demand is $\text{Exp}(1)$, $c_h = 4$, $c_s = 2$, and $p = 5$. The theoretical maximum value of the Lipschitz constant (for $γ = 0.9$) is
$L_V = 90$. In @fig-lipschitz-animation, we show the animation of this upper bound, in the style of the wikipedia animation shown at the beginning of this lecture. 
...
The proof of Lipschitz continuity for the inventory management problem in @exm-lipschitz-inventory is adapted from @Muller1997.
